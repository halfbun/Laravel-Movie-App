...
@section('content')
                                ...
                                <div class="bg-gray-900 rounded">
                                    ...
                                    <div class="modal-body px-8 py-8">
                                        <div class="responsive-container overflow-hidden relative" style="padding-top:56.25%">
                                            <iframe width="560" height="315" class="responsive-iframe absolute top-0 left-0 w-full min-h-full" src="https://youtube.com/embed/{{ $movie['videos']['results'][0]['key'] }}" allow="autoplay;encrypted-media;" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="movie-images border-b border-gray-800" x-data="{ isOpen: false, images: ''}">
        <div class="container mx-auto px-4 py-16">
